/**
	\file cBricksDatabaseProxyModel.h
	\brief A proxy model for editor of database of building blocks.
*/


#ifndef _CBRICKSDATABASEPROXYMODEL_H
#define _CBRICKSDATABASEPROXYMODEL_H
...
/**
	\brief A proxy model for editor of database of building blocks.
*/
class cBricksDatabaseProxyModel : public QSortFilterProxyModel {
