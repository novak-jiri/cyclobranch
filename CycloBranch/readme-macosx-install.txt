1) open CycloBranch-2.x.xxx.dmg, then drag and drop the CycloBranch folder into your "/Applications" folder 
...
- type "sudo chmod +x /Applications/CycloBranch/External/macosx/any2mzml.sh"
