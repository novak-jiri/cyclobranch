...
rem NoiseFilterGaussian.exe -in "%%f.FileConverter.mzML" -out "%%f.NoiseFilterGaussian.mzML" -algorithm:gaussian_width %2 1>NUL
BaselineFilter.exe -in "%%f.FileConverter.mzML" -out "%%f.BaselineFilter.mzML" 1>NUL
...
rem del "%%f.NoiseFilterGaussian.mzML" 2>NUL
