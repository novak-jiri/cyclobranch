...
sudo dpkg -i cyclobranch_2.x.xxx-1_amd64.deb
...
sudo dpkg -i OpenMS-2.3.0-Linux.deb
sudo chmod +x /usr/share/cyclobranch/External/linux/any2mgf.sh
sudo chmod +x /usr/share/cyclobranch/External/linux/any2mzml.sh
...
5) If you need a rpm file instead of deb file, use "sudo alien -r cyclobranch_2.x.xxx-1_amd64.deb" to create the rpm file.
